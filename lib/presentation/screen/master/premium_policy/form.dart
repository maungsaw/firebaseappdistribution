...
class PremiumPolicyForm extends StatefulWidget {
  final PremiumPolicyModel? data;
  final String formType;
  final String saveButtonText;
  final Function(PremiumPolicyModel?) onSave;

  const PremiumPolicyForm({
    super.key,
    this.data,
  ...
  @override
  State<PremiumPolicyForm> createState() => _PremiumPolicyFormState();
}

class _PremiumPolicyFormState extends State<PremiumPolicyForm> {
